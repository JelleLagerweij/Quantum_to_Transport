...
class Prot_Hop:
    ...
    def setting_properties_all(self):
        ...
        self.poss_all_split = pkl5.dumps(self.poss_all_split)
        self.force_split = pkl5.dumps(self.force_split)
        ...
        # Now redo together
        self.poss_all_split = pkl5.loads(self.poss_all_split)
        self.force_split = pkl5.loads(self.force_split)
